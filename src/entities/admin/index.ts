...
export {type IAdmin, type IAdminData, type IAdminFinance, type IAdminCreate, 
    type ITransactionsAdmin, type IAdminLesson, type IAdminFinanceByTgAdmins }  from './model/types'